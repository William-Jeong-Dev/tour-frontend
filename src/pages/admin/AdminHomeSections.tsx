        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_1fr]">
            ...
            <div className="rounded-2xl border border-neutral-900 bg-neutral-950/40 p-4">
                ...
                <div className="mt-3 max-h-[360px] overflow-auto space-y-2 pr-2">
                    ...
                    {!products.length ? (
                        <div className="text-xs text-neutral-500">PUBLISHED 상품이 없습니다.</div>
                    ) : null}
                </div>
                <div className="mt-2 text-xs text-neutral-500">
                    선택을 비워두면 홈에서는 기존처럼 자동(슬라이스) 노출됩니다.
                </div>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-900 bg-neutral-950/40 p-4">
                ...
                <div className="mt-3 space-y-2">
                    ...
                    {!selectedIds.length ? (
                        <div className="text-xs text-neutral-500">아직 선택된 상품이 없습니다.</div>
                    ) : null}
                </div>
            </div>
        </div>
    ...
    return (
        <div className="rounded-2xl border border-neutral-900 bg-neutral-950/30 p-5 space-y-4">
            ...
            <ProductPicker
                ...
                onChange={(ids) => setCfg({ ...cfg, productIds: ids })}
            />
...
export default function AdminHomeSections() {
    ...
    useEffect(() => {
        if (onsenQ.data) setOnsenCfg(onsenQ.data);
    }, [onsenQ.data]);
        ...
        <div className="space-y-6">
            <div>
                ...
                <div className="text-sm text-neutral-400">
                    홈 화면의 2개 섹션 문구/노출/상품 노출을 제어합니다.
                </div>
            </div>

            {loading ? (
                <div className="rounded-2xl border border-neutral-900 bg-neutral-950/30 p-6 text-sm text-neutral-300">
                    불러오는 중...
                </div>
            ) : null}
            ...
            <SectionEditor
                ...
                onSave={() => saveOnsen.mutate(onsenCfg)}
                extraTags
            />
        </div>
    );
