...
import { HeroSlide2, HeroCard2, useHeroSlides2, saveHeroSlides2 } from "../../hooks/useHeroSlides2";
...
// 기본 슬라이드 (따끈따끈 온천 골프용)
const defaultHeroSlides2: HeroSlide2[] = [
    {
        id: "default_onsen_1",
        title: "따끈따끈 온천 골프",
...
export default function HeroSlides2AdminPage() {
    const { slides, setSlides, loading } = useHeroSlides2(defaultHeroSlides2);
    ...
    const updateSlide = (index: number, patch: Partial<HeroSlide2>) => {
    ...
    const onSave = async () => {
        ...
        setSaving(true);
        const { error } = await saveHeroSlides2(slides);
        setSaving(false);
            ...
            <Container>
                <div className="py-8 md:py-10">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <h1 className="text-2xl font-extrabold tracking-tight text-neutral-100">히어로 슬라이드2 관리</h1>
                            <p className="mt-1 text-sm text-neutral-400">
                                홈 하단 "따끈따끈 온천 골프" 영역의 슬라이드(제목/태그/이미지/카드)를 관리합니다.
                            </p>
                            {msg ? (
                        ...
                        "
                                    ...
                                    <div className="mt-5 grid gap-6 lg:grid-cols-[1fr_360px]">
                                        ...
                                        <div className="space-y-5">
                                            {/* Title */}
                                            <div>
                                                <label className="text-sm font-semibold text-neutral-200">제목</label>
                                                <input
                                                    value={s.title}
                                                    onChange={(e) => updateSlide(idx, { title: e.target.value })}
                                                    placeholder="예) 따끈따끈 온천 골프"
                                                    className="
                          ...
                          "
                                            ...
                                            {/* Tags */}
                                            <div>
                                                <label className="text-sm font-semibold text-neutral-200">부제목/설명</label>
                                                <input
                                                    value={s.tags}
                                                    onChange={(e) => updateSlide(idx, { tags: e.target.value })}
                                                    placeholder="따뜻한 온천욕과 가이세키 코스 요리로 온천골프 만끽 🥰"
                                                    className="
                            mt-2 w-full rounded-xl
                            border border-neutral-800 bg-neutral-950 px-3 py-2
                            text-sm text-neutral-100 placeholder:text-neutral-500
                          ...
                          "
                                            ...
                                            {/* Hero image 업로드 */}
                                            <div>
                                                <label className="text-sm font-semibold text-neutral-200">왼쪽 대표 이미지 업로드</label>
                                                ...
                                                <div className="mt-2 flex flex-col gap-2">
                                                    <input
                                                        ...
                                                        onChange={async (e) => {
                                                            ...
                                                            const path = await uploadImage(file, "hero2");
                                                            if (!path) return;
                                ...
                                "
                                            ...
                                            <div className="pt-2">
                                                <div className="flex items-center justify-between">
                                                    <div>
                                                        <div className="text-sm font-extrabold text-white">오른쪽 카드 (상품 선택)</div>
                                                        <div className="mt-1 text-xs text-neutral-400">
                                                            1~3개를 추천합니다. 노출(PUBLISHED) 상품 중에서 선택하세요.
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <aside>
                                            ...
                                            <div className="mt-3 rounded-2xl border border-neutral-800 bg-neutral-950/40 p-4">
                                                ...
                                                <ul className="mt-2 list-disc space-y-1 pl-5 text-xs text-neutral-400">
                                                    <li>이미지는 업로드 후 path로 저장됩니다. (예: hero2/xxxx.png)</li>
                                                    <li>제목과 설명은 홈 페이지 하단에 표시됩니다.</li>
                                                    <li>카드는 1~3개가 가장 보기 좋아요.</li>
                                                </ul>
                                            </div>
                                        </aside>
                                    </div>
